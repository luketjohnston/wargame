...
function createAttack(t1, t2, i, j) {
  ...
  let text1 = new PIXI.Text(3, style);
  text1.x = -6;
  text1.y = 13;

  let text2 = new PIXI.Text(3, style);
  text2.scale.y = -1;
  text2.scale.x = -1;
  text2.x = 27;
  text2.y = 26;
