...
PIXI.Loader.shared.add(DJANGO_STATIC_URL + "/hexgame/images/map1.png").load(setup);

function setup() {
  // this code will run whent he loader has finished loading the image
  let map = new PIXI.Sprite(PIXI.Loader.shared.resources[DJANGO_STATIC_URL + "/hexgame/images/map1.png"].texture);
